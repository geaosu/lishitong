...
import com.geaosu.refreshx.util.DisplayUtil;
import com.geaosu.refreshx.view.FooterView;
import com.geaosu.refreshx.view.HeadRefreshView;
import com.geaosu.refreshx.view.HeadView;
import com.geaosu.refreshx.view.LoadMoreView;
...
public class PullToRefreshLayout extends FrameLayout {
     ...
     * 空布局是否可以被点击
     */
    public void setEmptyViewClickable(boolean emptyViewClickable) {
        this.mEmptyViewClickable = emptyViewClickable;
    }

    /**
     * 空布局是否可以被点击
     */
    public boolean isEmptyViewClickable() {
        return mEmptyViewClickable;
    }
    ...
    private void showEmptyView() {
        if (emptyView == null) {
            ...
            emptyView.setOnClickListener(new OnClickListener() {// 点击空布局，重新加载数据
                @Override
                public void onClick(View v) {
                    if (mEmptyViewClickable) {
                        switchView(ViewStatus.LOADING_STATUS);
                    }
                }
            });
            LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
